                    ...
                    <div class="form-group">
                        <label for="start_date" >Start Date*</label>
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control" id="datepicker1" name="start_date" value="{{old('start_date')}}" placeholder="Select start date" autocomplete="off">
                            </div>
                     ...
                     <div class="form-group">
                        <label for="end_date" >End Date</label>
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control" id="datepicker2" name="end_date" value="{{old('end_date')}}" placeholder="Select end date" autocomplete="off">
                            </div>
